...
public class Album extends javax.swing.JFrame {
    ...
    public Album() {
        ...
        controls.AlbumCommands.loadAlbum();
    }
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DeleteActionPerformed
        ...
        controls.AlbumCommands.deleteCard(cell);
    ...
    private void jButtonSaveChangesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_SaveChangesActionPerformed
        ...
        if (cardType.equalsIgnoreCase("Monster card")) {
            ...
            String rarity = jTableAlbum.getModel().getValueAt(row,6).toString();       
            ...
            String atribute = jTableAlbum.getModel().getValueAt(row,9).toString();
            ...
            MonsterCard monsterCard = new MonsterCard(name, rarity, edition,
									                  set, language, type,
									                  summMethod, atribute, 
									                  level, atk, def);
            
            monsterCard.editCard(cell);
